...
#define __HOURS__ ((__TIME__[0] - '0') * 10 + (__TIME__[1] - '0'))

#define __MINUTES__ ((__TIME__[3] - '0') * 10 + (__TIME__[4] - '0'))

#define __SECONDS__ ((__TIME__[6] - '0') * 10 + (__TIME__[7] - '0'))

// FAT16 Timestamping

#define FAT16_TODAY                                                            \
    (((__YEAR__ - 1980) << 9) | ((__MONTH__) << 5) | ((__DAY__)))

#define FAT16_NOW (((__HOURS__) << 11) | ((__MINUTES__) << 5) | ((__SECONDS__)))
