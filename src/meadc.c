...
__myevic__ void InitEADC() {
    if (ISCUBO200 || ISRX200S || ISRX23 || ISRX300) {
        ...
        SYS->GPB_MFPL |=
            (SYS_GPB_MFPL_PB0MFP_EADC_CH0 | SYS_GPB_MFPL_PB1MFP_EADC_CH1 |
        ...
        SYS->GPB_MFPL &= ~(SYS_GPB_MFPL_PB0MFP_Msk | SYS_GPB_MFPL_PB1MFP_Msk |
                           SYS_GPB_MFPL_PB2MFP_Msk | SYS_GPB_MFPL_PB6MFP_Msk);

        SYS->GPB_MFPL |=
            (SYS_GPB_MFPL_PB0MFP_EADC_CH0 | SYS_GPB_MFPL_PB1MFP_EADC_CH1 |
             SYS_GPB_MFPL_PB2MFP_EADC_CH2 | SYS_GPB_MFPL_PB6MFP_EADC_CH14);
