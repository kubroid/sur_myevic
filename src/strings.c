...
__string__ String_UnLock[] = {0xB0, 0x8F, 0xA7, 0x90,
                              0x84, 0x8C, 0}; // "UnLock"
__string__ String_Protection[] = {0xAB, 0x93, 0x90, 0x95, 0x86, 0x84,
                                  0x95, 0x8A, 0x90, 0x8F, 0}; // "Protection"
__string__ String_Version[] = {0xB1, 0x86, 0x93, 0x94,
                               0x8A, 0x90, 0x8F, 0}; // "Version"
__string__ String_Device[] = {0x9F, 0x86, 0x97, 0x8A,
                              0x84, 0x86, 0};        // "Device"
__string__ String_TooHot[]  = {0xA3, 0x90, 0x95, 0}; // "Hot"
__string__ String_Stealth[] = {0xAE, 0x95, 0x86, 0x82,
                               0x8D, 0x95, 0x89, 0};       // "Stealth"
__string__ String_Temp[]    = {0xAF, 0x86, 0x8E, 0x91, 0}; // "Temp"
__string__ String_Battery[] = {0x9D, 0x82, 0x95, 0x95,
                               0x86, 0x93, 0x9A, 0}; // "Battery"
__string__ String_Atomizer[] = {0x9C, 0x95, 0x90, 0x8E, 0x8A,
                                0x9B, 0x86, 0x93, 0};             // "Atomizer"
__string__ String_Found[]    = {0xA1, 0x90, 0x96, 0x8F, 0x85, 0}; // "Found"
__string__ String_Short[]    = {0xAE, 0x89, 0x90, 0x93, 0x95, 0}; // "Short"
__string__ String_LongFire[] = {0xA7, 0x90, 0x8F, 0x88, 0xBC,
                                0xA1, 0x8A, 0x93, 0x86, 0};
__string__ String_NewCoil[] = {0xA9, 0x86, 0x98, 0xBD, 0x9E,
                               0x90, 0x8A, 0x8D, 0};  // "New Coil"
__string__ String_SameCoil[] = {0xAA, 0x8D, 0x85, 0}; // Old
//__string__ String_Right 	[] = { 0xAD, 0x8A, 0x88, 0x89, 0x95, 0	};
//// "Right"
//__string__ String_Left 		[] = { 0xA7, 0x86, 0x87, 0x95, 0 }; //
//"Left"
__string__ String_Logo[] = {0xA7, 0x90, 0x88, 0x90, 0}; // "Logo"
__string__ String_Game[] = {0xA1, 0x8D, 0x82, 0x91,
                            0x91, 0x9A, 0}; // "Game" Flappy
__string__ String_Tetris[] = {0xAF, 0x86, 0x95, 0x93,
                              0x8A, 0x94, 0};             // "Tetris"
__string__ String_Easy[]   = {0xA0, 0x82, 0x94, 0x9A, 0}; // "Easy"
__string__ String_Normal[] = {0xA9, 0x90, 0x93, 0x8E,
                              0x82, 0x8D, 0};           // "Normal"
__string__ String_Hard[] = {0xA3, 0x82, 0x93, 0x85, 0}; // "Hard"
__string__ String_Exit[] = {0xA0, 0x99, 0x8A, 0x95, 0}; // "Exit"
//__string__ String_Back 		[] = { 0x9D, 0x82, 0x84, 0x8C, 0 }; //
//"Back"
...
//__string__ String_BF_s 		[] = { 0x69, 0x6D, 0	}; // "BF"
//(small)
__string__ String_TCR[]   = {0xAF, 0x9E, 0xAD, 0}; // "TCR"
__string__ String_PWR_s[] = {
    0xE4, 0}; //[] = { 0x77, 0x7E, 0x79, 0 }; // "PWR" (small)
__string__ String_AMP_s[] = {
    0xE5, 0}; //[] = { 0x68, 0x74, 0x77, 0 }; // "AMP" (small)
...
__string__ String_TCRSet[] = {0xAF, 0x9E, 0xAD, 0xBC,
                              0xAE, 0x86, 0x95, 0}; // "TCR Set"
__string__ String_POWER[] = {0xBD, 0xBD, 0xAB, 0xAA, 0xB2,
                             0xA0, 0xAD, 0xBD, 0xBD, 0}; // "   POWER   "
__string__ String_BYPASS[] = {0xBD, 0x9D, 0xB4, 0xAB, 0x9C,
                              0xAE, 0xAE, 0xBD, 0xBD, 0}; // " BYPASS  "
__string__ String_VOLT_s[] = {
    0xE6, 0}; //[] = { 0x7D, 0x76, 0x73, 0x7B, 0 }; // "VOLT" (small)
__string__ String_COIL_s[] = {
    0xE9, 0}; //[] = { 0x6A, 0x76, 0x70, 0x73, 0 }; // "COIL" (small)
__string__ String_TIME_s[] = {
    0xE7, 0}; //[] = { 0x7B, 0x70, 0x74, 0x6C, 0 }; // "TIME" (small)
__string__ String_PUFF_s[] = {
    0xE8, 0}; //[] = { 0x77, 0x7C, 0x6D, 0x6D, 0 }; // "PUFF" (small)
...
__string__ String_BOARD_s[] = {0xF2,
                               0}; //[] = { 0x69, 0x76, 0x68, 0x79, 0x6B, 0 };
__string__ String_RES_s[] = {0xEB, 0}; //[] = { 0x79, 0x6C, 0x7A, 0 };
__string__ String_LIQ_s[] = {0xF3, 0}; //[] = { 0x73, 0x70, 0x78, 0 };
__string__ String_SMART[] = {0xBD, 0xBD, 0xAE, 0xA8, 0x9C,
                             0xAD, 0xAF, 0xBD, 0xBD, 0}; // "  SMART  "
__string__ String_Contrast[] = {0x9E, 0x90, 0x8F, 0x95, 0x93,
                                0x82, 0x94, 0x95, 0};
//__string__ String_LongFireTo	[] = { 0xA7, 0x90, 0x8F, 0x88, 0xBC, 0xA1,
// 0x8A, 0x93, 0x86, 0 };
...
//__string__ String_TEMP_NI_s	[] = { 0x7B, 0x6C, 0x74, 0x77, 0xBD, 0x75,
// 0x70, 0x00 };
//__string__ String_TEMP_TI_s	[] = { 0x7B, 0x6C, 0x74, 0x77, 0xBD, 0x7B,
// 0x70, 0x00 };
//__string__ String_TEMP_SS_s	[] = { 0x7B, 0x6C, 0x74, 0x77, 0xBD, 0x7A,
// 0x7A, 0x00 };
//__string__ String_TCR_s		[] = { 0x7B, 0x6A, 0x79, 0x00 };
//__string__ String_POWER_s	[] = { 0x77, 0x76, 0x7E, 0x6C, 0x79, 0x00 };
//__string__ String_BYPASS_s	[] = { 0x69, 0x80, 0x77, 0x68, 0x7A, 0x7A,
// 0x00 };
//__string__ String_SMART_s	[] = { 0x7A, 0x74, 0x68, 0x79, 0x7B, 0x00 };
__string__ String_Coils[]    = {0x9E, 0x90, 0x8A, 0x8D, 0x94, 0};
__string__ String_Zero_All[] = {0xB5, 0x86, 0x93, 0x90, 0xBC,
                                0x9C, 0x8D, 0x8D, 0};
__string__ String_Miscs[] = {0xA8, 0x8A, 0x94, 0x84, 0x94, 0};
//__string__ String_DateTime	[] = { 0x9F, 0x82, 0x95, 0x86, 0xBD, 0xD6,
// 0xBD, 0xAF, 0x8A, 0x8E, 0x86, 0 };
...
__string__ String_Box[]   = {0x9D, 0x90, 0x99,
                           0}; //{ 0x9E, 0x96, 0x83, 0x86, 0 };cube
...
__string__ String_Interface[] = {0xA4, 0x8F, 0x95, 0x86, 0x93,
                                 0x87, 0x82, 0x84, 0x86, 0};
...
//__string__ String_SetTime	[] = { 0xAE, 0x86, 0x95, 0xBD, 0xAF, 0x8A,
// 0x8E, 0x86, 0 };
//__string__ String_SetDate	[] = { 0xAE, 0x86, 0x95, 0xBD, 0x9F, 0x82,
// 0x95, 0x86, 0 };
...
//__string__ String_ModePlus	[] = { 0xA8, 0x90, 0x85, 0x86, 0xBD, 0xD4,
// 0xD4, 0 };
...
//__string__ String_mld		[] = { 0xF6, 0 }; //[] = { 0x8E, 0x8D, 0xD6,
// 0x85, 0 };
...
__string__ String_Imbalanced[] = {0xA4, 0x8E, 0x83, 0x82, 0x8D, 0x82,
                                  0x8F, 0x84, 0x86, 0x85, 0};
__string__ String_Batteries[] = {0x9D, 0x82, 0x95, 0x95, 0x86,
                                 0x93, 0x8A, 0x86, 0x94, 0};
...
//__string__ String_BALANCE_s	[] = { 0x69, 0x68, 0x73, 0x68, 0x75, 0x6A,
// 0x6C, 0 };
...
__string__ String_Spinner[] = {0xAE, 0x91, 0x8A, 0x8F,
                               0}; // 0x8F, 0x86, 0x93, 0 };
...
//__string__ String_ProfPlus	[] = { 0xAB, 0x93, 0x90, 0x87, 0xC1, 0xBD,
// 0xD4, 0xD4, 0 };
...
__string__ String_Wednesday[] = {0xB2, 0x6C, 0x6B, 0x75, 0x6C,
                                 0x7A, 0x6B, 0x68, 0x80, 0};
__string__ String_Thursday[] = {0xAF, 0x6F, 0x7C, 0x79, 0x7A,
                                0x6B, 0x68, 0x80, 0};
__string__ String_Friday[]   = {0xA1, 0x79, 0x70, 0x6B, 0x68, 0x80, 0};
__string__ String_Saturday[] = {0xAE, 0x68, 0x7B, 0x7C, 0x79,
                                0x6B, 0x68, 0x80, 0};
__string__ String_Survival[] = {0xAE, 0x96, 0x93, 0x97, 0x8A,
                                0x97, 0x82, 0x8D, 0};
...
__string__ String_ZeroCnts[] = {0xB5, 0x86, 0x93, 0x90, 0x9E,
                                0x8F, 0x95, 0x94, 0};
