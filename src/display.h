...
extern void DrawHLineDots(const int x1, const int y, const int x2,
                          const int color);
...
extern void DrawFillRect(const int x1, const int y1, const int x2, const int y2,
                         const int color);
extern void DrawFillRectLines(const int x1, const int y1, const int x2,
...
extern void DrawValueRight(int x, int y, int v, uint8_t dp, uint8_t z,
                           uint8_t nd);
extern void DrawValueInv(int x, int y, int v, uint8_t dp, uint8_t z,
                         uint8_t nd);
...
extern void SSD1306_WriteBytes(const int isData, const uint8_t data[],
                               const int len);
...
extern void SSD1327_WriteBytes(const int isData, const uint8_t data[],
                               const int len);
